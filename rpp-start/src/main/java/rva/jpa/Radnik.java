...
public class Radnik implements Serializable {
	...
	@Id
	@SequenceGenerator(name="RADNIK_IDRADNIK_GENERATOR", sequenceName="RADNIK_SEQ", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="RADNIK_IDRADNIK_GENERATOR")
